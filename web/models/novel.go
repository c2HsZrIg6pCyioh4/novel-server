...
type Novel struct {
	...
	// 审核相关
	AuditStatus int            `json:"audit_status" gorm:"default:0"` // 0=待审核 1=通过 2=拒绝
	AuditBy     sql.NullString `json:"audit_by" gorm:"size:100"`      // 可以为空
	AuditAt     *time.Time     `json:"audit_at"`                      // 可以为空
